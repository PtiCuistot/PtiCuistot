...
# -----------------------------------------------------------------------------
#       TABLE : PC_TAG_REFERENCE
# -----------------------------------------------------------------------------

CREATE TABLE IF NOT EXISTS PC_TAG_REFERENCE
 (
   REP_ID SMALLINT NOT NULL AUTO_INCREMENT,
   TA_ID INTEGER NOT NULL  ,
   TA_CONTENT VARCHAR(32) NOT NULL  
   , PRIMARY KEY (REP_ID,TA_ID,TA_CONTENT) 
 ) 
 comment = "";

# -----------------------------------------------------------------------------
#       INDEX DE LA TABLE PC_TAG_REFERENCE
# -----------------------------------------------------------------------------


CREATE  INDEX I_FK_PC_TAG_REFERENCE_PC_RECIPE
     ON PC_TAG_REFERENCE (REP_ID ASC);

CREATE  INDEX I_FK_PC_TAG_REFERENCE_PC_TAGS
     ON PC_TAG_REFERENCE (TA_ID ASC,TA_CONTENT ASC);
...
ALTER TABLE PC_TAG_REFERENCE 
  ADD FOREIGN KEY FK_PC_TAG_REFERENCE_PC_RECIPE (REP_ID)
      REFERENCES PC_RECIPE (REP_ID) ;


ALTER TABLE PC_TAG_REFERENCE 
  ADD FOREIGN KEY FK_PC_TAG_REFERENCE_PC_TAGS (TA_ID,TA_CONTENT)
